...
@ExperimentalUnsignedTypes
public actual fun UByteArray.toUint8Array(): Uint8Array {
...
public actual fun Float32Array.toFloatArray(): FloatArray =
    FloatArray(this.length) { this[it] }

/** Returns a new [Float32Array] containing all the elements of this [FloatArray]. */
public actual fun FloatArray.toFloat32Array(): Float32Array {
...
public actual fun Float64Array.toDoubleArray(): DoubleArray =
    DoubleArray(this.length) { this[it] }

/** Returns a new [Float64Array] containing all the elements of this [DoubleArray]. */
public actual fun DoubleArray.toFloat64Array(): Float64Array {
