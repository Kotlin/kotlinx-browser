 ...
 */
public actual external open class URL actual constructor(url: String, base: String) : JsAny {
 ...
 */
public actual external open class URLSearchParams actual constructor(init: JsAny? /* String|URLSearchParams */) : JsAny {
    actual fun append(name: String, value: String)
    actual fun delete(name: String)
    actual fun get(name: String): String?
    actual fun getAll(name: String): JsArray<JsString>
