...
public actual external abstract class MediaList : ItemArrayLike<JsString>, JsAny {
...
public actual operator fun MediaList.get(index: Int): String? = getMethodImplForMediaList(this, index)

/**
 * Exposes the JavaScript [StyleSheet](https://developer.mozilla.org/en/docs/Web/API/StyleSheet) to Kotlin
 */
public actual external abstract class StyleSheet : JsAny {
 ...
 */
public actual external abstract class CSSStyleSheet : StyleSheet, JsAny {
 ...
 */
public actual external abstract class StyleSheetList : ItemArrayLike<StyleSheet>, JsAny {
...
public actual operator fun StyleSheetList.get(index: Int): StyleSheet? = getMethodImplForStyleSheetList(this, index)

/**
 * Exposes the JavaScript [LinkStyle](https://developer.mozilla.org/en/docs/Web/API/LinkStyle) to Kotlin
 */
public actual external interface LinkStyle : JsAny {
 ...
 */
public actual external abstract class CSSRuleList : ItemArrayLike<CSSRule>, JsAny {
...
public actual operator fun CSSRuleList.get(index: Int): CSSRule? = getMethodImplForCSSRuleList(this, index)

/**
 * Exposes the JavaScript [CSSRule](https://developer.mozilla.org/en/docs/Web/API/CSSRule) to Kotlin
 */
public actual external abstract class CSSRule : JsAny {
 ...
 */
public actual external abstract class CSSStyleRule : CSSRule, JsAny {
...
public actual external abstract class CSSImportRule : CSSRule, JsAny {
    actual open val href: String
    actual open val media: MediaList
 ...
 */
public actual external abstract class CSSGroupingRule : CSSRule, JsAny {
    actual open val cssRules: CSSRuleList
    actual fun insertRule(rule: String, index: Int): Int
    actual fun deleteRule(index: Int)
 ...
 */
public actual external abstract class CSSMediaRule : CSSGroupingRule, JsAny {
    actual open val media: MediaList
 ...
 */
public actual external abstract class CSSPageRule : CSSGroupingRule, JsAny {
    actual open var selectorText: String
    actual open val style: CSSStyleDeclaration
...
public actual external abstract class CSSMarginRule : CSSRule, JsAny {
 ...
 */
public actual external abstract class CSSNamespaceRule : CSSRule, JsAny {
 ...
 */
public actual external abstract class CSSStyleDeclaration : ItemArrayLike<JsString>, JsAny {
    actual open var cssText: String
    actual open val parentRule: CSSRule?
...
public actual operator fun CSSStyleDeclaration.get(index: Int): String? = getMethodImplForCSSStyleDeclaration(this, index)

public actual external interface ElementCSSInlineStyle : JsAny {
 ...
 */
public actual external abstract class CSS : JsAny {
    actual companion object {
        actual fun escape(ident: String): String
    }
}

public actual external interface UnionElementOrProcessingInstruction