...
public expect interface ClipboardEventInit : EventInit, JsAny {
    open var clipboardData: DataTransfer? /* = null */
}

@Suppress("UNUSED_PARAMETER")
public expect fun ClipboardEventInit(clipboardData: DataTransfer? = null, bubbles: Boolean? = false, cancelable: Boolean? = false, composed: Boolean? = false): ClipboardEventInit

/**
 * Exposes the JavaScript [ClipboardEvent](https://developer.mozilla.org/en/docs/Web/API/ClipboardEvent) to Kotlin
 */
public expect open class ClipboardEvent(type: String, eventInitDict: ClipboardEventInit = definedExternally) : Event, JsAny {
...
public expect interface ClipboardPermissionDescriptor : JsAny {
    open var allowWithoutGesture: Boolean? /* = false */
}

@Suppress("UNUSED_PARAMETER")
public expect fun ClipboardPermissionDescriptor(allowWithoutGesture: Boolean? = false): ClipboardPermissionDescriptor